...
void Inversa(double x, double y, double z) {
  ...
  if ( (pow(a4, 2) + pow(wlinha, 2) - pow(a5, 2) ) / ( 2 * a4 * wlinha ) > 1)
  {
  ...
  else if ((pow(a4, 2) + pow(wlinha, 2) - pow(a5, 2) ) / ( 2 * a4 * wlinha ) < -1)
  {
    int parteInteira = (pow(a4, 2) + pow(wlinha, 2) - pow(a5, 2) ) / ( 2 * a4 * wlinha );
  ...
  if ( (pow(a4, 2) + pow(a5, 2) - pow(wlinha, 2) ) / (2 * a4 * a5) > 1)
  {
  ...
  else if ( pow(a4, 2) + pow(a5, 2) - pow(wlinha, 2) / (2 * a4 * a5) < -1)
  {
    int parteInteira = (pow(a4, 2) + pow(a5, 2) - pow(wlinha, 2) ) / (2 * a4 * a5);
