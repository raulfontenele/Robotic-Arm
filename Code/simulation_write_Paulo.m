...
[t1,t2,t3] = cinematica_inversa4(50,0,-50);
i = 1;
[x(i),y(i),z(i)] = direct_kinematic(t1,t2,t3);

[t11,t22,t33] = cinematica_inversa4(100,0,-50);
...
[t11,t22,t33] = cinematica_inversa4(100,30,-50);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t2,t3);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t22,t3);
...
[t11,t22,t33] = cinematica_inversa4(80,30,-50);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t2,t3);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t22,t3);
...
[t11,t22,t33] = cinematica_inversa4(80,0,-50);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t2,t3);
i = i+1;
[x(i),y(i),z(i)] = direct_kinematic(t11,t22,t3);
...
[t1,t2,t3] = cinematica_inversa4(100,0,-50);
[t11,t22,t33] = cinematica_inversa4(100,15,-50);
...
[t1,t2,t3] = cinematica_inversa4(100,15,-50);
[t11,t22,t33] = cinematica_inversa4(80,15,-50);
...
[t1,t2,t3] = cinematica_inversa4(80,15,-50);
[t11,t22,t33] = cinematica_inversa4(80,0,-50);
